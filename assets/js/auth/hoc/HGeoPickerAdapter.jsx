/**
 * Adapter to use HGeoPicker as a widget using a redux container to dynamically pass and update props
 */


import React, { Component } from "react";
import HGeoPicker from "../organisms/HGeoPicker";
...
class HGeoPickerAdapterComponent extends Component {
    constructor(props) {
        super(props);
        ...
        console.log("HGeoPickerAdapterComponent build");
    }
...
const ConnectedHGeoPickerAdapter = connect((state)=>({containerProps:state}))(HGeoPickerAdapterComponent);
...
class Adapter extends Component{
    ...
    render(){
        return (
            <Provider store={store}><ConnectedHGeoPickerAdapter {...this.props}/></Provider>)
    }
};

export const HGeoPickerAdapter = Adapter;
