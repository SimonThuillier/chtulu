...
let _getTypeFromHDate = function(hDate, width) {
    let dayCount = hDate.getIntervalSize();
    if (dayCount < (40 * width) / 1000) {
        return "day";
    } else if (dayCount < (200 * width) / 1000) {
        return "week";
    } else if (dayCount < (1200 * width) / 1000) {
        return "month";
    } else if (dayCount < (16000 * width) / 1000) {
        return "year";
    } else if (dayCount < (160000 * width) / 1000) {
        return "decade";
    } else if (dayCount < (1600000 * width) / 1000) {
        return "century";
    } else {
        return "millennium";
    }
