...
$.hbase.func.factory = function(type)
{
	...
	newModal = function(z = 7,fadeTime = 250)
	{
	...
	{
		var text = ''
		$paragraph = $('<p style="color:grey display:inline">');
		$paragraph.maxLength=255;
		$paragraph.warningThreshold=0.9;
...
$.widget( "hbase.hmaxlength", {
	...
	_create: function() {
		...
		console.log($element);
		$paragraph = $.hbase.func.factory("hmaxlength");
